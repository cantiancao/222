...
#import "HCHomeCell.h"
@interface HCMyrecordViewController ()

@end

@implementation HCMyrecordViewController
...
- (void)requstData {
    ...
    [[HCNetworkTool sharedNetworkTool] POSTLoginWithUrlString:@"http://188z20966o.iok.la:41428/article/myHistory.htm" parameters:param successBlock:^(NSURLSessionDataTask *task, id responseObject) {
